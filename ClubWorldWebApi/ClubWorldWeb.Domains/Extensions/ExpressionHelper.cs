...
namespace ClubWorldWeb.Domains.Extensions
{
            ...
            if (prop != null && fieldValue != null)
            {
                ...
                switch (selectedOperator)
                {
                    ...
                    case OperationExpression.StartsWith:
                        ...
                        var bodyStartsWith = Expression.Call(expressionParameter, startsWith, Expression.Constant(fieldValue, prop.PropertyType));
